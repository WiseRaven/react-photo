        ...
        1: [
            function (e, t, n) {
                ...
                function throttle(func, wait, options) {
                    ...
                    if (!options) options = {};
                    var later = function() {
                        previous = options.leading === false ? 0 : Date.now || function() {
                ...
                var s = Object.assign || function (e) {
                    ...
                    o = function () {
                        function e(t, n) {
                            ...
                            this.element = t || document.querySelector(".cocoen"), this.init()
                        }
                        ...
                        return r(e, [{
                            ...
                            value: function () {
                                ...
                                var el;
                                var labels = this.options.dragLabels;
                                var labelClassname = this.options.dragLabelSelector.replace(".", "");
                                if (labels && labels.length) {
                                    for (var i = 0; i < labels.length; i++) {
                                        el = document.createElement('span');
                                        labelClassname && el.classList.add(labelClassname);
                                        el.innerText = labels[i];
                                        e.insertBefore(el, null);
                                    }
                                }

                                var handlerSelector = this.options.dragHandlerSelector;
                                if (handlerSelector) {
                                    el = document.createElement('span');
                                    el.classList.add( handlerSelector.replace(".", "") );
                                    e.insertBefore(el, null);
                                }
                                ...
                                n = this.element.querySelector("picture,img");
                                ...
                                this.beforeImage = this.beforeElement.querySelector("picture,img")
                            }
                        }, {
                            key: "addEventListeners", value: function () {
                                ...
                                window.addEventListener("resize", throttle(this.dimensions.bind(this), 250, {leading: false, trailing: true}))
                            }
                        }, {
                            ...
                            key: "onDragStart", value: function (e) {
                                e.preventDefault();
                                var t = e.pageX ? e.pageX : e.touches[0].pageX, n = this.dragElement.getBoundingClientRect().left + document.body.scrollLeft;
                ...
                o.defaults = {
                    ...
                    dragHandlerSelector: '.cocoen-handler',
                    dragLabelSelector: '.cocoen-label',
                    dragLabels: ['before', 'after'],
                    dragCallback: null
                },
                t.exports = o
            },
